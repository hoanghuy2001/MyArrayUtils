...
def test_SelectionSort_empty_array():
    arr = []
    expected = []
...
def test_SelectionSort_empty_array_with_reverse():
    arr = []
    expected = []
    sort.SelectionSort(arr, reverse=True)
    assert arr == expected
def test_SelectionSort_int_array():
...
def test_SelectionSort_int_array_with_reverse():
    arr = [1, 4, 77, 5, 6, 12, 24]
...
def test_SelectionSort_int_array_with_cmp():
    arr = [1, 4, 77, 5, 6, 12, 24]
    expected = [1, 4, 5, 6, 12, 24, 77]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.SelectionSort(arr, cmp=cmp)
    assert arr == expected


def test_SelectionSort_int_array_with_reverse_and_cmp():
    arr = [1, 4, 77, 5, 6, 12, 24]
    expected = [77, 24, 12, 6, 5, 4, 1]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.SelectionSort(arr, reverse=True, cmp=cmp)
    assert arr == expected


def test_SelectionSort_sorted_int_array():
    arr = [1, 2, 3, 4, 5, 6, 7]
...
def test_SelectionSort_sorted_int_array_with_reverse():
    arr = [1, 2, 3, 4, 5, 6, 7]
...
def test_SelectionSort_sorted_int_array_with_cmp():
    arr = [1, 2, 3, 4, 5, 6, 7]
    expected = [1, 2, 3, 4, 5, 6, 7]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.SelectionSort(arr, cmp=cmp)
...
def test_SelectionSort_sorted_int_array_with_reverse_and_cmp():
    arr = [1, 2, 3, 4, 5, 6, 7]
    expected = [7, 6, 5, 4, 3, 2, 1]
    def cmp(x, y): return -1 if x < y else 1 if x > y else 0
    sort.SelectionSort(arr, reverse=True, cmp=cmp)
...
def test_SelectionSort_string_array():
...
def test_SelectionSort_string_array_with_reverse():
    arr = ['test', 'quick', 'sort', 'with', 'string',
           'array', 'hope', 'all', 'tests', 'are', 'passed']
...
def test_SelectionSort_string_array_with_cmp():
    arr = ['test', 'quick', 'sort', 'with', 'string',
           'array', 'hope', 'all', 'tests', 'are', 'passed']
    expected = ['all', 'are', 'array', 'hope', 'passed',
                'quick', 'sort', 'string', 'test', 'tests', 'with']
...
def test_SelectionSort_string_array_with_reverse_and_cmp():
    arr = ['test', 'quick', 'sort', 'with', 'string',
           'array', 'hope', 'all', 'tests', 'are', 'passed']
    expected = ['with', 'tests', 'test', 'string', 'sort',
                'quick', 'passed', 'hope', 'array', 'are', 'all']
...
def test_SelectionSort_dict_array_with_cmp():
    arr = [
        {'id': 1, 'age': 20},
        {'id': 2, 'age': 12},
        {'id': 3, 'age': 26},
...
def test_SelectionSort_long_int_array():
